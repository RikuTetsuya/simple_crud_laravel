      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form method="POST" action="{{ url('/simpan_sub_department') }}">
              @csrf
              <div class="card-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Sub-Department</label>
                ...
                <div class="form-group">
                  <label for="exampleInputPassword1">Status Sub-Department</label>
